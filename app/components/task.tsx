    ...
    <div className={styles.instructions}>
      ...
      <div className={styles.topic_desc}>
        ...
        <div className={styles.desc_item}>
          Create a simple <b>responsive e-commerce</b> app using <b>NextJs</b>.
        </div>
        <div className={styles.item_nr}>2.</div>
        <div className={styles.desc_item}>
          It should include a <b>Home page</b> and <b>Add-To-Cart Modal</b>.
          Click the button to switch between the home page and the Add-To-Cart
          Modal{" "}
          <button
            type="button"
